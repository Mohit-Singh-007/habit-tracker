...
const StatisticsScreen = () => {
  ...
  const { data: detailedStats, isLoading: detailedLoading } =
    useDetailedStats();
      ...
      <SafeScreen>
        ...
        >
          <View className="px-6 py-8">
            <Text className="text-3xl font-bold font-outfit text-gray-900">
              Statistics
            </Text>
            <Text className="mt-1 text-gray-500 font-inter">
              Your habits journey
            </Text>
          </View>
          ...
          <View className="px-6">
                  ...
                  {detailedStats.bestHabits.map((habit: any, idx: number) => (
                    ...
                    >
                      <View className="flex-row items-center gap-3">
                        ...
                        />
                        <Text className="font-semibold text-gray-800 font-inter">
                          {habit.name}
                        </Text>
                      </View>
            ...
            <View className="mb-8 flex-row gap-4">
              <View className="flex-1 rounded-[32px] bg-white p-6 shadow-sm border border-gray-100">
                ...
                <Text className="text-xs font-bold text-gray-400 tracking-widest uppercase font-inter">
                  Total Logs
                </Text>
                <Text className="mt-1 text-3xl font-black text-gray-900 font-outfit">
                  {detailedStats?.allTimeStats?.totalLogs || 0}
                </Text>
              </View>
              <View className="flex-1 rounded-[32px] bg-white p-6 shadow-sm border border-gray-100">
                ...
                <Text className="mt-1 text-3xl font-black text-gray-900 font-outfit">
                  {detailedStats?.allTimeStats?.totalHabits || 0}
                </Text>
              </View>
            </View>
